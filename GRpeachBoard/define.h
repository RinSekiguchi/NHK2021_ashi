...
#define MANUAL_LOWPASS_T  ( 0.03 )
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

// >>> PathTrackingで使用 >>>>>>>>>>>>>>>>>>
#define POSI_X_KP    ( 0.7 )
#define POSI_X_KI    ( 0.0 )
#define POSI_X_KD    ( 0.0 )

#define POSI_Y_KP    ( 0.7 )
#define POSI_Y_KI    ( 0.0 )
#define POSI_Y_KD    ( 0.0 )

#define POSI_Z_KP    ( 2.4 )
#define POSI_Z_KI    ( 0.0 )
#define POSI_Z_KD    ( 0.01 )

#define YOKOZURE_KP    ( 0.7 )
#define YOKOZURE_KI    ( 0.0 )
#define YOKOZURE_KD    ( 0.0 )

#define KAKUDO_KP    ( 2.4 )
#define KAKUDO_KI    ( 0.0 )
#define KAKUDO_KD    ( 0.01 )
...
#define RADIUS_X    ( 0.024639) // X軸計測輪の半径[m]
#define RADIUS_Y    ( 0.024418) // Y軸計測輪の半径[m]
